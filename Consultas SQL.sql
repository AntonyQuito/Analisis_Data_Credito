...
/*Pregunta 2
2.	¿Cuáles niveles educativos tienen un limite_credito promedio superior a $8,500, 
considerando solo aquellos grupos que tengan más de 2000 clientes en la base de datos?*/
...
/*Pregunta  3
3.	¿Qué grupos  segun su estado civil y sexo tienen un promedio de meses_inactivo mayor a 1,
pero a la vez generan un volumen total de transacciones  superior a $100,000?*/
...
/*Pregunta  4
4.	¿Cuáles son los id y el tipo_tarjeta de los clientes que realizaron una cantidad de
transacciones  superior al promedio de transacciones de los clientes 
que tienen tarjeta 'Blue'?*/
...
5.	¿Cuáles son los id de los clientes cuyo valor de transacción anual supera en al menos el doble (200%) 
el promedio de gasto de su mismo segmento demográfico (definido por estado civil y salario anual)?*/ 
...
/* Pregunta 6
6.	¿Cuáles son los clientes que se ubican en el percentil 95 o superior de inactividad , cuentan con 4 o más
productos , y cuyo límite de crédito intacto supera la media global de toda la cartera?*/
...
/* Pregunta 7
7. ¿Cuál es el límite de crédito promedio y cuántos clientes hay dependiendo de qué tanto exprimen su tarjeta?
Clasifica a los clientes en 'Uso Alto' (gastan más del 70% de su límite), 'Uso Medio' (entre 30% y 70%) y 'Uso Bajo' (menos del 30%).*/
...
/* Pregunta 8
8. ¿Quiénes son los 3 clientes con la mayor cantidad de transacciones anuales dentro de cada tipo de tarjeta para 
incluirlos en una campaña de recompensas?*/
...
/*Pregunta 9
9. ¿Cuál es la tasa exacta de morosidad, junto con el volumen total de clientes y los casos específicos de impago,
segmentando la cartera por estado civil y sexo?
*/
...
/*Pregunta 10
10. ¿Qué clientes generan un volumen de transacciones superior al promedio global, pero experimentan alta fricción 
con el banco al registrar 4 o más iteraciones de servicio?*/
